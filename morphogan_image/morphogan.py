...
class MORPHOGAN(object):
    ...
    def __init__(self, model='morphogan', \
        ...
        self.nb_test_real = 100
        self.nb_test_fake = 20
    ...
    def create_discriminator(self):
        if self.nnet_type == 'dcgan' and self.db_name == 'mnist':
            ...
            return discriminator_hdcgan_galaxyzoo
        else:
    ...
    def create_generator(self):
        if self.nnet_type == 'dcgan' and self.db_name == 'mnist':
            ...
            return generator_hdcgan_galaxyzoo    
        else:
            print('The dataset are not supported by the network');
    ...
    def create_model(self):
        ...
        self.X_p = tf.placeholder(tf.float32, shape=[self.batch_size, self.data_dim])
        ...
        with tf.variable_scope('discriminator'):
            ...
            interpolation = self.X + (alpha*differences)
